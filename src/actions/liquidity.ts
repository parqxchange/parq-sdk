...
import { poolStatePDA, vaultAuthorityPDA, lpMintPDA, usdcVaultPDA } from "../utils/pda";
...
export async function addLiquidity(
  ...
  const ix = await opts.poolClient.depositIx(
    { poolState, usdcVault, vaultAuthority, lpMint, userLp: accounts.userLp, userUsdc: accounts.userUsdc, depositor: accounts.depositor },
